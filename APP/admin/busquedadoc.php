...
?>
    <tr>
      ...
      <td width="80px"><a href="seccion.php?id=<?php echo $documento['id']?>"><img src="<?php echo $servidor ?>/img/secciones.png" title="Ver secciones" alt="Secciones" /> Secciones</a></td>
      <td width="50px"><a href="editar.php?id=<?php echo $documento['id']?>"><img src="<?php echo $servidor ?>/img/editar.png" title="Editar" alt="Editar" /> Editar</a></td>
      <td width="65px"><a onClick="EliminarDocumento(<?php echo $documento['id'] ?>); return false" href="eliminar.php?id=<?php echo $documento['id']?>"><img src="<?php echo $servidor ?>/img/eliminar.png" title="Eliminar" alt="Eliminar" /> Eliminar</a></td>
    </tr>
<?php
	}
}
